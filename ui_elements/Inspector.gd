...
func populate_creature_tab(creature:CreatureModel) -> void:
	...
	get_node("Creature/col1/creature_subtype/value").text = CreatureType.SUBTYPE.keys()[creature.subtype]
	get_node("Creature/col2/creature_location/value").text = 'x: %d, y: %d' % [creature.x, creature.y]
...
func populate_tile_tab(tile: OrcGameMapTile):
	...
	get_node("Tile/col2/tile_type/value").text = TerrainConstants.TILE_TYPE.keys()[tile.tile_type]
